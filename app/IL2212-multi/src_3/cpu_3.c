...
#define shared_address_offset_for_cpu3 1728 // = 2*8*36*3
#define cropSIZE  36
#define img_h 64
#define img_w 64
	...
	while (1) {
		//if(!altera_avalon_mutex_is_mine(mutex_3)) {
			...
			* */
			...
			readAddress = (int*)(shared + shared_address_offset_for_cpu3 )- cropSIZE_int_RGB;
...
//			*shared = 23;
			altera_avalon_mutex_lock(mutex_3, 1);
			writeBackPointer = (INT16U*)(shared + results_offset) + 6;
